/**
 * Agent diagnostic builders.
 *
 * Mirrors open-design runtimes/diagnostics.ts 1:1 — same reason taxonomy,
 * same severity mapping, same fix-action ordering, same searchedDirs cap.
 * The three builders emit the typed AgentDiagnostic shape the UI renders as
 * "one-line reason + fix button(s)".
 */
import type { AgentDiagnostic, RuntimeAgentDef } from '@journal/contracts'
import type { AgentFixIntent } from '@journal/contracts'
 ...
 * missing / unverifiable credential.
 */
