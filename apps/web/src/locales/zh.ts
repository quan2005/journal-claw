...
export const zh: Strings = {
  ...
  agentRunStatusRunning: '进行中',
  agentRunStatusDone: '已完成',
  agentRunStatusFailed: '已失败',
  agentRunStatusCanceled: '已取消',
  agentRunStatusNeedsConfirmation: '需确认',
  // Agent Run — 流式区块标题
  agentRunSectionTimeline: '时间线',
  agentRunSectionOutput: '输出',
  agentRunSectionFileChanges: '文件改动 ({count})',
  agentRunSectionSourcesRead: '读取的来源 ({count})',
  agentRunSectionArtifacts: '产物 ({count})',
  agentRunSectionMemory: '记忆 ({count})',
  // Agent Run — 时间线状态事件
  agentRunEventStarted: '任务开始',
  agentRunEventFinished: '任务完成',
  agentRunEventFailed: '任务失败',
  // Agent Run — 记忆类型
  agentRunMemoryPref: '偏好',
  agentRunMemoryFact: '事实',
  agentRunMemoryRule: '规则',
  agentRunMemoryTool: '工具',
  agentRunMemoryNote: '备注',
  // Agent Run — 改动集操作标签
  agentRunChangeOpCreate: '新建',
  agentRunChangeOpEdit: '编辑',
  agentRunChangeOpMove: '移动',
  agentRunChangeOpRemove: '删除',
  // Agent Run — 改动集状态标签
  agentRunChangeStatusApplied: '已应用',
  agentRunChangeStatusBlocked: '已阻止',
  agentRunChangeStatusFailed: '已失败',
  agentRunChangeStatusReverted: '已回滚',
  agentRunChangeStatusRecorded: '已记录',
  // Agent Run — 来源绑定类型标签
  agentRunSourceKindRead: '读取',
  agentRunSourceKindReference: '引用',
  agentRunSourceKindSearch: '搜索',
  agentRunSourceKindCite: '引证',
  // Agent Run — 产物类型标签
  agentRunArtifactTypeArticle: '文章',
  agentRunArtifactTypeOutline: '大纲',
  agentRunArtifactTypeReport: '报告',
  agentRunArtifactTypeSummary: '摘要',
  agentRunArtifactTypePlan: '计划',
  agentRunArtifactTypeTodo: '待办',
  agentRunArtifactTypeIndex: '索引',
