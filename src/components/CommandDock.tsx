...
export function CommandDock({
  ...
  return (
    ...
    >
      ...
      <div
        onClick={() => {
          if (activeMode === 'idle') setInputOpen(true)
        }}
        style={{
          flex: 1,
          borderRadius: 8,
          ...
          >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                stroke="var(--dock-dropzone-hover-border)"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 'var(--text-base)', color: 'var(--dock-dropzone-text)' }}>
                {t('pastePrompt')}
              </div>
              <div
                style={{
                  fontSize: 'var(--text-xs)',
                  color: 'var(--dock-dropzone-hint)',
                  marginTop: 2,
                }}
              >
                {t('aiArchiveHint')}
                ...
                {pendingFiles.slice(0, 6).map((path, i) => {
                  ...
                  return (
                    <FileCard
                      ...
                      onOpen={() =>
                        openFile(path).catch((err) => console.error('[open-file]', err))
                      }
                    />
                  )
                })}
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                  ...
                  >
                    <span style={{ opacity: 0.5, marginRight: 5, fontSize: '0.9em' }}>Esc</span>
                    {t('cancel')}
                  </button>
                  <button
                    onClick={(e) => {
                    ...
                    style={actionBtnSubmit}
                  >
                    <span style={{ opacity: 0.6, marginRight: 5, fontSize: '0.9em' }}>↵</span>
                    {t('submit')}
                  </button>
                </div>
              </div>
              ...
              <textarea
                ...
                placeholder={
                  hasFiles ? t('textareaPlaceholderFiles') : t('textareaPlaceholderText')
                }
      ...
      <div style={{ flexShrink: 0 }}>
          ...
          style={
            {
              ...
              justifyContent: 'center',
              cursor:
                recorderStatus !== 'recording' && asrReady === false ? 'not-allowed' : 'pointer',
        ...
        >
          {recorderStatus === 'recording' ? (
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--record-btn-icon)">
