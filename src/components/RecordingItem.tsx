...
export function RecordingItem({
  ...
  const duration =
    isActive && elapsedSecs !== undefined
    ...
    >
      ...
      >
        {showDate && dayNum ? (
          <>
            ...
            <span
              style={{ fontSize: 'var(--text-xs)', color: 'var(--date-secondary)', lineHeight: 1 }}
            >
              {weekday}
            </span>
          </>
      ...
      >
        ...
        >
          {isActive ? (
            <span
              style={{ color: 'var(--record-btn)', animation: 'blink 1s ease-in-out infinite' }}
            >
              {duration}
            </span>
          ) : (
