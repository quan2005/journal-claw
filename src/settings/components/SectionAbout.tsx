      ...
      {loading ? (
        ...
        <div style={{ animation: 'section-fadein 160ms ease-out both' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <div
              style={{ fontSize: 16, color: 'var(--item-meta)', marginTop: 10, lineHeight: 1.5 }}
            >
              {t('tagline')}
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--duration-text)', letterSpacing: '0.03em' }}>
              {t('addWeChat')}
            </div>
          </div>
          ...
          <div style={{ marginTop: 36, textAlign: 'center' }}>
            <div style={{ fontSize: 13, color: 'var(--item-meta)' }}>
              {t('version', { version })}
            </div>
            <div
              style={{
